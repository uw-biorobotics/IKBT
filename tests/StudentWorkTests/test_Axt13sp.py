...
# Axtman 2013sp,
# DOF: 4
# methods to test: m5, m2, m6
Axtman13sp_dh = sp.Matrix([
    [0.,        0.,         d_1,        0.],
    [sp.pi/2,   0.,         l_2,        th_2],
    [sp.pi/2,   0.,         0.,         th_3],
    [0.,        l_3,        0.,         th_4],
...
Axtman13sp_vv = [0, 1, 1, 1, 0, 0]
Axtman13sp_unk = [d_1, th_2, th_3, th_4]

dh = Axtman13sp_dh
vv = Axtman13sp_vv
unknowns = Axtman13sp_unk
...
if treeTest:
    ...
    covertToSucc = b3.Inverter(repeatCommons)
