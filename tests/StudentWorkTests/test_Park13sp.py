...
# Parkman 2013sp
# DOF: 5
# methods to test: m5, m6, m3, m2
Parkman13sp_dh = sp.Matrix([
    [0.,        0.,         h,          th_1],
    [sp.pi/2,   0.,         0.,         th_2   ],
    [0.,        l_2,        0.,         th_3],
    [sp.pi,     l_3,        d_4,        0.],
...
Parkman13sp_vv = [1, 1, 1, 0, 1, 0]
Parkman13sp_unk = [th_1, th_2, th_3, d_4, th_5]

dh = Parkman13sp_dh
vv = Parkman13sp_vv
unknowns = Parkman13sp_unk
...
if treeTest:
    ...
    repeatRound = b3.RepeatUntilSuccess(oneRound, 5) 
