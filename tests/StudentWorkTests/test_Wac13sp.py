...
# Wachtveitl 2013sp
# DOF: 5
# methods to test: m5, m6
Wachtveitl13sp_dh = sp.Matrix([
    [-sp.pi/2,  0.,         d_1,        0.],
    [sp.pi/2,   0.,         h,          th_2],
    [sp.pi/2,   0.,         0.,         th_3],
    [0.,        l_2,        l_3,        th_4],
...
Wachtveitl13sp_vv = [0, 1, 1, 1, 1, 0]
Wachtveitl13sp_unk = [d_1, th_2, th_3, th_4, th_5]

dh = Wachtveitl13sp_dh
vv = Wachtveitl13sp_vv
unknowns = Wachtveitl13sp_unk
...
if treeTest:
    ...
    #oneRound = b3.Sequence([sumID, convertToSucc, updateT, compDet])
