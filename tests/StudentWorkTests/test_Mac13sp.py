...
# Mackler 2013sp
# DOF: 5
# methods to test: m6, m5
Mackler13sp_dh = sp.Matrix([
    [-sp.pi/2,  h,          d_1,        0.],
    [sp.pi/2,   0.,         l_1,        th_2],
    [sp.pi/2,   l_2,        0.,         th_3],
    [sp.pi/2,   0.,         l_3,        th_4],
...
Mackler13sp_vv = [0, 1, 1, 1, 1, 0]
Mackler13sp_unk = [d_1, th_2, th_3, th_4, th_5]

dh = Mackler13sp_dh
vv = Mackler13sp_vv
unknowns = Mackler13sp_unk
...
if treeTest:
    ...
    sandcID.BHdebug = True
    
    sandcSol = sinandcos_solve()
    sandcSol.Name = "sin and cos solve"
    sandcSol.BHdebug = True
    
    sandcMod = b3.Sequence([sandcID, sandcSol])
    ...
    commonTricks = b3.Priority([subID, algMod, tanMod, sincosMod, sandcMod])
    ...
    #oneRound = b3.Sequence([sumID, repeatCommons, compDet])
    oneRound = b3.Sequence([convertToSucc, compDet])
